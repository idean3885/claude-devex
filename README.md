...
| **틀린 것은 다음 작업이 읽게 남긴다** | 작업 끝에 교정을 레슨런으로 뽑아 자산으로 등재하고, 다음 작업 시작에 인덱스를 로드해 판단 지점에서 대조 → [레슨런 자산화](docs/lessons.md)<br>재발하면 차단 규칙을 늘리지 않고 원인을 분석한다 |
...
- 레슨런 자산화의 지표는 항목만 정의하고 값은 비워 뒀습니다
- 적용 범위는 아직 1인입니다
